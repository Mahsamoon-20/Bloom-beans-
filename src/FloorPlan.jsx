...
const INDOOR = [
  { id:"kitchen",   label:"Kitchen &\nCooking Lessons", icon:"🍳", x:0,  y:0,  w:10, h:7,  c:"kitchen",   area:70,  desc:"Accessible worktops at wheelchair height. Cooking lesson space for 12 participants. Direct garden access for harvesting fresh produce for the café." },
  { id:"studio",    label:"Art & Design\nStudio",        icon:"🎨", x:10, y:0,  w:10, h:7,  c:"studio",    area:70,  desc:"Creative workspace with adaptive tools and extra-wide aisles. Dedicated wall storage for art supplies. Participants display and sell their work in the café." },
  { id:"sensory",   label:"Sensory\nQuiet Room",         icon:"🌿", x:20, y:0,  w:10, h:7,  c:"sensory",   area:70,  desc:"Calming retreat space with adjustable soft lighting, sound-absorbing panels, and tactile wall features. Direct door to the outdoor sensory garden walk." },
  { id:"office",    label:"Staff\nOffice",               icon:"🏢", x:0,  y:7,  w:6,  h:6,  c:"office",    area:36,  desc:"Admin hub and care coordination. Government-funded staff base with private meeting room and observation window to main corridor." },
  { id:"storage",   label:"Storage &\nUtility",          icon:"📦", x:6,  y:7,  w:4,  h:6,  c:"storage",   area:24,  desc:"Adaptive equipment, café supplies, garden tools and cleaning. Accessible shelving and utility sink." },
  { id:"cafe",      label:"Café & Dining Area",          icon:"☕", x:10, y:7,  w:20, h:6,  c:"cafe",      area:120, desc:"The heart of the institute! 40+ fully accessible seats. Run by participants — open to the public, families, supporters and the community." },
  { id:"reception", label:"Reception\n& Entry Hall",     icon:"🚪", x:0,  y:13, w:9,  h:7,  c:"reception", area:63,  desc:"Welcoming accessible street entrance. Information desk, sign-in area, and display of participant artwork and fresh garden produce for sale." },
  { id:"corridor",  label:"Accessible\nCorridor",        icon:"♿", x:9,  y:13, w:5,  h:7,  c:"corridor",  area:35,  desc:"Extra-wide central corridor with tactile floor guide strips. Connects all ground-floor spaces. Emergency-accessible throughout." },
  { id:"wc",        label:"Accessible\nWashrooms",       icon:"🚻", x:14, y:13, w:6,  h:7,  c:"wc",        area:42,  desc:"3 large accessible stalls with ceiling hoist track, adult change table, full wheelchair turning radius, and family cubicle." },
  { id:"lounge",    label:"Family\nLounge",              icon:"❤️", x:20, y:13, w:10, h:7,  c:"lounge",    area:70,  desc:"Dedicated rest space for families and carers while participants are in program. Comfortable seating, small kitchenette, quiet and welcoming." },
];

const OUTDOOR = [
  { id:"patio",   label:"Covered Patio",         icon:"⛱️", x:0,  y:0,  w:20, h:5,  c:"patio",   area:100, desc:"All-weather shaded outdoor dining extending the café. Pergola roof with climbing plants. Accessible tables at varied heights, heated for colder months." },
  { id:"shed",    label:"Garden Shed",            icon:"🛖",  x:20, y:0,  w:5,  h:5,  c:"shed",    area:25,  desc:"Accessible garden shed with wheelchair-height potting bench. Organized tool storage, seed station, and participant project storage." },
  { id:"sGarden", label:"Sensory Garden\nWalk",  icon:"🌸", x:25, y:0,  w:5,  h:14, c:"sGarden", area:70,  desc:"Winding accessible path lined with fragrant and textured plants — lavender, mint, rosemary. Seating alcoves and small water feature throughout." },
  { id:"bed1",    label:"Raised Beds\nVegetables",icon:"🥕", x:0,  y:5,  w:8,  h:5,  c:"garden",  area:40,  desc:"Wheelchair-height raised beds growing seasonal vegetables and herbs. Harvested by participants and used fresh in the café kitchen." },
  { id:"bed2",    label:"Raised Beds\nFlowers",  icon:"🌻", x:8,  y:5,  w:9,  h:5,  c:"garden",  area:45,  desc:"Pollinator garden with sunflowers, marigolds and wildflowers. A cut-flower station — participants arrange and sell bouquets in the café." },
  { id:"bed3",    label:"Raised Beds\nFruit",    icon:"🍓", x:17, y:5,  w:8,  h:5,  c:"garden",  area:40,  desc:"Dwarf fruit trees and berry bushes in accessible containers. Strawberries, blueberries and seasonal fruit used in café baking lessons." },
  { id:"path",    label:"Accessible Path Loop",  icon:"👣", x:0,  y:10, w:25, h:4,  c:"path",    area:100, desc:"Wide smooth paved loop connecting all garden zones. Anti-slip surface, gentle gradient. A therapeutic walking and sensory route for participants." },
];
